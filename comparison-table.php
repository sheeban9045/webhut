    ...
    <div class="announcement-div">
        ...
        <div id="<?php echo "announcement-$announcement->id"; ?>" class="alert alert-danger">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                class="feather feather-volume-2 icon-18 mr10">
                <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon>
                <path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path>
            </svg>
            <a style="color: black;font-weight: bold;" href="store-admin/index.php/announcements"
                style="color:Red"><?php echo $announcement['title'];?></a>
    ...
    <div class="container-fluid pb-5">
        <div class="text-center">
            ...
            <div class="price-btn" style="display: block;">
                <a href="javascript:void(0);" id="monthly"
                    class="price-btn-bg btn btn-xl btn-outline-light my-2 mx-2">Monthly Fee</a>
                <a href="javascript:void(0);" id="one-time" class="btn btn-xl btn-outline-light my-2 mx-2">One Time
                    Fee</a>
            </div>
        </div>
        ...
        <div id="monthly-section">
            <div class="row text-center mb-5">
                <div class="col-lg-12 col-md-12">
                    <div class="price-btn">
                        <p class="white_text mt-3 mb-0">Host and Manage your Website on our Servers for a Monthly Fee!
                        </p>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center"><a
                                        href="store-admin/index.php/items/pricing_add_to_cart/<?php echo $item['id']; ?>"
                                        class="btn align-middle btn-primary my-2 my-lg-0"><i class="fa fa-shopping-cart"
                                            aria-hidden="true"></i>&nbsp;&nbsp;Buy Now</a></td>
                                <?php }} ?>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td class="text-center">
                                    <a class="btn align-middle btn-outline-primary my-2 my-lg-0"
                                        href="<?php echo $item['demo_url']; ?>" target="_blank">▶ Demo</a>
                                </td>
                                <?php }} ?>
                            </tr>
        ...
        <div id="one-time-section">
            <div class="row text-center mb-5">
                <div class="col-lg-12 col-md-12">
                    <div class="price-btn">
                        <p class="white_text mt-3 mb-0">Host, Manage, setup, and install your website on your own server
                            for a one time fee</p>
                    </div>
                </div>
            </div>
