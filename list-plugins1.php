    ...
    <div class="modal1" id="modal">
        ...
        <div class="modal-body">
            ...
            <div class="modal-sidebar">
                ...
                <!-- DEMO BUTTON -->
                <button class="btn-demo" id="demoBtn" style="display:none;">
...
<script>
    function openModal(plugin) {
        ...
        // CODE
        document.getElementById('infoCode').innerText =
            plugin.code || '-';

        // BEST SALE
        if(plugin.is_best_sale == 1){

            document.getElementById('bestSaleWrapper').style.display = 'inline-flex';

        } else {

            document.getElementById('bestSaleWrapper').style.display = 'none';
        }

        // FEATURED
        if(plugin.is_featured == 1){

            document.getElementById('featuredWrapper').style.display = 'inline-flex';

        } else {

            document.getElementById('featuredWrapper').style.display = 'none';
        }
        ...
        if(plugin.discount_type == 'percentage'){
            ...
            discountAmount =
                (oldPrice * parseFloat(plugin.discount_value || 0)) / 100;
        ...
        if(discountAmount > 0){
            ...
            if(plugin.discount_type == 'percentage'){
                ...
                label = plugin.discount_value + '% off';
        ...
        document.getElementById('modalBuyBtn').onclick = function () {
            ...
            window.location.href =
                '/store-admin/index.php/Webhut_plugins/checkout/' + plugin.id;
        };
